            ...
            <div className="h-full flex overflow-hidden">
              <ScrollArea className="px-3">
                <div className="space-y-0.5">
                  <p className="text-text-1 text-lg font-semibold">Category</p>
                ...
                <div className="my-5 space-y-0.5">
                  ...
                  <p className="text-text-6 text-lg">
                    Get ready to groove with our exciting Dance Challenge! Show
                    off your unique moves, record your performance, and share it
                    with the world. Compete for amazing prizes, gain
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-x-3">
                          <p className="text-text-2 text-xs">{comment.time}</p>
                          <button
                            type="button"
